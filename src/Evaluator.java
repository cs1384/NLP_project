...
public class Evaluator {
    ...
    private List<String> grader2ScaleGrade_G;
    private List<String> grader2ScaleGrade_NG;

    private Judger jg7Scale;
    private Judger jg3Scale;
    private Judger jg2Scale;

    private List<String> tomatoGrade7Scale;
    private List<String> tomatoGrade3Scale;
    private List<String> tomatoGrade2Scale;
    ...
    private RawreviewGradeLabler lb2Scale;
    ...
    public Evaluator(Grader gd) {
        ...
        grader2ScaleGrade_G = new ArrayList<>();
        grader2ScaleGrade_NG = new ArrayList<>();

        tomatoGrade7Scale = new ArrayList<>();
        tomatoGrade3Scale = new ArrayList<>();
        tomatoGrade2Scale = new ArrayList<>();
        ...
        GradeScale scale2 = new GradeScale();
        scale2.add2Scale();
        jg2Scale = new Judger(scale2);
        ...
        lb3Scale.set3Scale();
        lb2Scale = new RawreviewGradeLabler();
        lb2Scale.set2Scale();
    }
...
//        }
    ...
    private List<Double> precision(){
        double totalGrade = 0;
        double correct3G = 0, corret3NG = 0, correct7G = 0, correct7NG = 0, correct2G = 0, correct2NG = 0;
        for(int i = 0; i < tomatoGrade3Scale.size(); i++){
            ...
            if(grader2ScaleGrade_G.get(i).equals(tomatoGrade2Scale.get(i))){
                correct2G++;
            }
            if(grader2ScaleGrade_NG.get(i).equals(tomatoGrade2Scale.get(i))){
                correct2NG++;
            }
        }
